    ...
    <header className="flex items-center justify-between border-b border-white/[0.06] px-6 py-3">
      <div className="flex items-center gap-2 font-mono text-xs">
        <button
          ...
          aria-label="Back"
          title="Back"
          className="flex min-h-9 min-w-9 items-center justify-center rounded-md border border-white/10 text-white/50 transition hover:bg-white/[0.04] hover:text-white/80"
        >
